...
Aşağıdakileri yap:   
   ...
   İPUCU: fonksiyon oluşturmaya gerek yok
*/
let biricinciDeger = 10;
let ikinciDeger = 8;
if (biricinciDeger > ikinciDeger) {
  biricinciDeger = ikinciDeger;
}
console.log(biricinciDeger);
/*
